  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          ...
                          Text('الحالة: ${transaction.status.isEmpty ? 'غير متوفرة' : transaction.status}'),
                        ],
                      ),
                      trailing: Text('الفترة: ${transaction.dueDate}'),
                    ),
                  );
                },
              ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => provider.fetchTransactions(employeeId),
